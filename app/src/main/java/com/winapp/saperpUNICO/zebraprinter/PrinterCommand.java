...
//        }
    ...
    public static byte[] getBitmapPrintData(Bitmap bmp , int width, int bmpMode){
        ...
        byte[] printBMPPackageHead = bmpCmdHead(bmpMode,bmpNewWidth);
        ...
        for(int n = 0; n < bmpBlockNums; n++)
        {
            ...
            System.arraycopy(byteMerger(bmpBlockPrintData),0,bmpPrintData,n*bmpBlockCMDSize,bmpBlockCMDSize);
        }
    ...
    {
        byte[] result = new byte[]{Command.ESC,42,0,0,0};
        result[2] = (byte)mode;
