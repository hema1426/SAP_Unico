...
public class SapPosting_INVPreviewPrintAdapter extends RecyclerView.Adapter<SapPosting_INVPreviewPrintAdapter.ViewHolder> {
    ...
    public SapPosting_INVPreviewPrintAdapter(Context context, ArrayList<ReportPostingInvSOModel.ReportInvoiceDetails> reportInvoiceDetailsArrayList) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ReportPostingInvSOModel.ReportInvoiceDetails reportSalesSummarymodel =reportInvoiceDetailsArrayList.get(position);
