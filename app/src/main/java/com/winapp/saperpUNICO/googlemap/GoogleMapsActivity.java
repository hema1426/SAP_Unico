package com.winapp.saperpUNICO.googlemap;
...
public class GoogleMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapStyleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popupMenu = new PopupMenu(GoogleMapsActivity.this, menuItemView);
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      /*  LatLng barcelona = new LatLng(41.385064,2.173403);
        ...
        GeoApiContext context = new GeoApiContext.Builder()
                .apiKey("AIzaSyCFHOv4YAYpAoVXmhq6xMCg_x2BoRTCLZE")
                .build();
   ...
   /*     Polygon polygon = mMap.addPolygon(new PolygonOptions()
        ...
        Polyline line = mMap.addPolyline(new PolylineOptions()
                .add(new LatLng(9.939093, 78.121719), new LatLng(9.587209, 77.951431))
                .width(5)
                .color(Color.RED));
