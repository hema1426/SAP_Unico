...
import com.winapp.saperpUNICO.model.InvoiceData;
import com.winapp.saperpUNICO.model.Invoices;
...
public class TableListFragment extends Fragment {
    ...
    public void loadData() {
        ...
        for(int i = -1; i < rows; i ++) {
            ...
            final LinearLayout layCustomer = new LinearLayout(getActivity());
            ...
            if (i > -1) {
                final TextView tv3b = new TextView(getActivity());
            ...
            final LinearLayout layAmounts = new LinearLayout(getActivity());
            ...
            if (i > -1) {
                final TextView tv4b = new TextView(getActivity());
