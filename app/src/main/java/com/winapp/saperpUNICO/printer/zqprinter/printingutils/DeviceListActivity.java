package com.winapp.saperpUNICO.printer.zqprinter.printingutils;
...
import com.winapp.saperpUNICO.printer.zqprinter.printingutils.zqprinterlib.SWZQPrinter;
...
public class DeviceListActivity extends AppCompatActivity implements Runnable {
    ...
    String titleToPrint="New Title";
    String messageToPrint="New Message";
