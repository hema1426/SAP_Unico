 ...
 * Every location changes will update the particular activity method
 * if location disable means we can't get the location
 * user need to give the permission to obtained the location
 * we can get the current location with every changes of the location and update the ui
 *
 */
